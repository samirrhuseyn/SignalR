...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20240324101340_AddedChatAndAppUserRelation")]
    partial class AddedChatAndAppUserRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Chat", b =>
                {
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Chat", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.AppUser", "Person1User")
                        .WithMany("Person1")
                        .HasForeignKey("Person1ID")
                        .IsRequired();

                    b.HasOne("SignalR.EntityLayer.Entities.AppUser", "Person2User")
                        .WithMany("Person2")
                        .HasForeignKey("Person2ID")
                        .IsRequired();

                    b.Navigation("Person1User");

                    b.Navigation("Person2User");
                });

            modelBuilder.Entity("SignalR.EntityLayer.Entities.Message", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.Chat", "Chat")
                        .WithMany()
                        .HasForeignKey("ChatID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SignalR.EntityLayer.Entities.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
